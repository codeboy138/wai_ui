...
(function (global) {
    const SPECS = {
        ...
        'header-window-controls-container': {
            ...
            io: { input: [], output: [] },
            logic: '각 버튼은 Python backend를 통해 OS 윈도우 제어.',
            py_func: null,
            js_action: null,
            events: [],
        ...
        'main-left-assets-add-btn': {
            ...
            desc: '좌측 패널 - 자산 추가 버튼',
            io: { input: ['click'], output: ['backend.import_asset'] },
            logic: '클릭 시 Python backend.import_asset 호출.',
            py_func: 'import_asset',
            js_action: null,
            events: ['click'],
            affects: ['main-left-assets-list'],
            examples: ['data-action="py:import_asset"']
        },
        'main-left-assets-list': {
            module: 'panel.left.assets',
            desc: '좌측 패널 - 자산 리스트',
            io: { input: [], output: [] },
            logic: '초기에는 플레이스홀더를 표시.',
            py_func: null,
            js_action: null,
            events: [],
            affects: [],
        ...
        'main-left-resizer-v': {
            ...
            io: { input: ['mousedown', 'mousemove', 'mouseup'], output: ['state.leftPanelWidth 변경'] },
        ...
        'preview-toolbar-panel': {
            ...
            js_action: null,
            events: [],
            affects: ['preview-toolbar-ratio-dropdown', 'preview-toolbar-resolution-dropdown', 'preview-toolbar-snap-toggle', 'preview-toolbar-coord-box'],
            examples: []
        },
        'preview-toolbar-ratio-dropdown': {
            module: 'preview.toolbar',
            desc: '프리뷰 - 캔버스 비율 선택 드롭다운',
            io: { input: ['select'], output: ['state.aspectRatio 변경'] },
            logic: '선택한 비율에 따라 캔버스 가로세로 비를 조정.',
            py_func: null,
            js_action: 'setAspect',
            events: ['change'],
        ...
        'preview-toolbar-coord-box': {
            ...
            io: { input: ['mousemove (on canvas)'], output: ['coord 텍스트 업데이트'] },
        ...
        'preview-toolbar-resolution-dropdown': {
            ...
            io: { input: ['select'], output: ['state.resolution 변경'] },
            logic: '해상도 프리셋 변경.',
            py_func: null,
        ...
        'preview-toolbar-snap-toggle': {
            module: 'preview.toolbar',
            desc: '프리뷰 - SNAP 토글 스위치',
            io: { input: ['click'], output: ['state.isMagnet 토글'] },
            logic: '캔버스 내 박스 이동/정렬 시 스냅 기능 온/오프.',
            py_func: null,
            js_action: 'toggleSnapMagnet',
            events: ['click'],
            affects: ['preview-canvas-scaler'],
            examples: ['data-action="js:toggleSnapMagnet"']
        },
        'preview-canvas-wrapper': {
            module: 'preview.canvas',
            desc: '프리뷰 캔버스 래퍼',
            io: { input: ['mousemove', 'mouseleave'], output: ['mouseCoord, isMouseOverCanvas 업데이트'] },
        ...
        'preview-canvas-scaler': {
            module: 'preview.canvas',
            desc: '프리뷰 캔버스 스케일러',
            io: { input: ['ResizeObserver(wrapper)'], output: ['state.canvasScale 변경'] },
        ...
        'preview-canvas-overlay-root': {
            ...
            desc: '프리뷰 캔버스 상의 박스들을 감싸는 오버레이 루트',
            io: { input: ['click'], output: ['select-box(null) emit', 'contextMenu 닫힘'] },
        ...
        'preview-canvas-box-{id}': {
            ...
            desc: '프리뷰 캔버스 상의 개별 레이어 박스',
            io: { input: ['mousedown', 'drag', 'resize', 'contextmenu'], output: ['select-box(boxId) emit', 'updateBoxPosition 호출', 'remove-box emit'] },
            logic: 'interact.js를 사용해 위치/크기를 조정.',
            py_func: null,
            js_action: 'selectCanvasBox',
            events: ['mousedown', 'drag', 'resize', 'contextmenu'],
            affects: ['preview-canvas-scaler', 'panel-right-props-root'],
            examples: ['data-action="js:selectCanvasBox"']
        },
        'preview-canvas-context-menu': {
            module: 'preview.canvas.context',
            desc: '프리뷰 캔버스 박스용 컨텍스트 메뉴 루트',
            io: { input: ['click(메뉴 항목)'], output: ['remove-box emit'] },
        ...
        'preview-canvas-context-top-btn': {
            module: 'preview.canvas.context',
            desc: '선택 박스를 맨 위로 올리는 컨텍스트 메뉴 항목',
            io: { input: ['click'], output: [] },
            logic: '향후 선택된 박스의 zIndex를 최상단으로 올리는 기능 예정.',
            py_func: null,
            js_action: 'canvasContextBringToFront',
            events: ['click'],
            affects: ['preview-canvas-box-{id}'],
            examples: ['data-action="js:canvasContextBringToFront"']
        },
        'preview-canvas-context-delete-btn': {
            module: 'preview.canvas.context',
            desc: '선택 박스를 삭제하는 컨텍스트 메뉴 항목',
            io: { input: ['click'], output: ['remove-box emit'] },
            logic: '선택된 박스를 프리뷰 캔버스에서 제거.',
            py_func: null,
            js_action: 'canvasContextDelete',
            events: ['click'],
            affects: ['preview-canvas-box-{id}', 'panel-right-props-root'],
            examples: ['data-action="js:canvasContextDelete"']
        },
        ...
        'main-center-timeline-resizer-h': {
            ...
            io: { input: ['mousedown', 'mousemove', 'mouseup'], output: ['previewContainerHeight, timelineContainerHeight 변경'] },
        ...
        'timeline-header-bar': {
            ...
            js_action: null,
            events: [],
            affects: ['timeline-header-collapse-btn', 'timeline-header-timecode-label', 'timeline-header-zoom-slider'],
            examples: []
        },
        ...
        'timeline-header-zoom-slider': {
            module: 'timeline.header',
            desc: '타임라인 줌 슬라이더',
            io: { input: ['input'], output: ['vm.zoom 변경'] },
            logic: '줌 레벨을 변경하여 타임축 단위를 조절.',
            py_func: null,
            js_action: 'timelineChangeZoom',
            events: ['input'],
            affects: ['timeline-time-ruler-row', 'timeline-clip-{id}'],
            examples: ['data-action="js:timelineChangeZoom"']
        },
        'timeline-toolbar-quick-bar': {
            ...
            js_action: null,
            events: [],
            affects: ['timeline-tool-cut-btn', 'timeline-tool-delete-btn', 'timeline-tool-magnet-btn', 'timeline-tool-ripple-btn', 'timeline-tool-normalize-btn', 'timeline-tool-volume-icon'],
            examples: []
        },
        'timeline-tool-cut-btn': {
            ...
            events: ['click'],
            affects: [],
            examples: ['data-action="js:timelineToolCut"']
        },
        'timeline-tool-delete-btn': {
            ...
            events: ['click'],
            affects: [],
            examples: ['data-action="js:timelineToolDelete"']
        },
        'timeline-tool-magnet-btn': {
            module: 'timeline.toolbar',
            desc: '타임라인 스냅(마그넷) 토글 버튼',
            io: { input: ['click'], output: ['vm.isMagnet 토글'] },
            logic: '클립/플레이헤드 이동 시 스냅 여부를 제어.',
            py_func: null,
            js_action: 'toggleTimelineMagnet',
            events: ['click'],
            affects: ['timeline-clip-{id}', 'timeline-playhead-handle'],
            examples: ['data-action="js:toggleTimelineMagnet"']
        },
        'timeline-tool-ripple-btn': {
            module: 'timeline.toolbar',
            desc: '타임라인 오토 리플 토글 버튼',
            io: { input: ['click'], output: ['vm.isAutoRipple 토글'] },
            logic: '클립 편집 시 이후 클립들을 자동으로 당기거나 밀지 여부를 제어.',
            py_func: null,
            js_action: 'toggleTimelineRipple',
            events: ['click'],
            affects: ['timeline-clip-{id}'],
            examples: ['data-action="js:toggleTimelineRipple"']
        },
        'timeline-tool-normalize-btn': {
            module: 'timeline.toolbar',
            desc: 'Normalize 버튼',
            io: { input: ['click'], output: [] },
            logic: '클릭 시 선택된 오디오 클립 볼륨을 정규화하는 기능 연결 예정.',
            py_func: null,
            js_action: 'timelineNormalizeAudio',
            events: ['click'],
            affects: ['timeline-clip-{id}'],
            examples: ['data-action="js:timelineNormalizeAudio"']
        },
        'timeline-tool-volume-icon': {
            module: 'timeline.toolbar',
            desc: '타임라인 전체 볼륨 컨트롤 아이콘',
            io: { input: ['click'], output: [] },
            ...
            events: ['click'],
            affects: [],
            examples: ['data-action="js:timelineVolumeControl"']
        },
        'timeline-scroll-container': {
            module: 'timeline.scroll',
            desc: '트랙/클립 및 시간 룰러를 포함하는 스크롤 영역',
            io: { input: ['dragover', 'drop', 'wheel'], output: ['스크롤 위치 변경', '클립 추가'] },
            ...
            examples: ['data-action="js:timelineDropAsset"']
        },
        ...
        'timeline-track-row-{id}': {
            module: 'timeline.track',
            desc: '각 타임라인 트랙 행',
            io: { input: ['dragstart', 'dragenter', 'dragend'], output: ['vm.moveTrack 호출'] },
            logic: '드래그 앤 드롭으로 트랙 순서를 재배치.',
            py_func: null,
            js_action: 'timelineTrackReorder',
            events: ['dragstart', 'dragenter', 'dragend'],
            affects: ['timeline-lane-row-{id}'],
            examples: ['data-action="js:timelineTrackReorder"']
        },
        'timeline-track-name-{id}': {
            module: 'timeline.track',
            desc: '트랙 이름 텍스트',
            io: { input: ['text edit'], output: ['track.name 변경'] },
        ...
        'timeline-lane-container': {
            ...
            io: { input: ['mousedown', 'mousemove', 'mouseup'], output: ['vm.currentTime 변경'] },
            logic: '클릭/드래그로 플레이헤드를 이동.',
            py_func: null,
        ...
        'timeline-clip-{id}': {
            ...
            desc: '각 트랙에 배치된 개별 클립 박스',
            io: { input: ['click', 'drag', 'resize'], output: ['vm.setSelectedClip', 'vm.moveClip', 'vm.updateClip'] },
            ...
            examples: ['data-action="js:selectTimelineClip"']
        },
        ...
        'main-right-resizer-v': {
            ...
            io: { input: ['mousedown', 'mousemove', 'mouseup'], output: ['state.rightPanelWidth 변경'] },
        ...
        'panel-right-layer-root': {
            ...
            js_action: null,
            events: [],
            affects: ['panel-right-layer-header', 'panel-right-layer-matrix-container', 'panel-right-layer-save-template-btn'],
            examples: []
        },
        'panel-right-layer-header': {
            module: 'panel.right.layer',
            desc: '우측 레이어 패널 헤더',
            io: { input: ['click'], output: ['isCollapsed 토글'] },
            logic: '클릭 시 레이어 매트릭스 영역을 접거나 펼침.',
            py_func: null,
            js_action: 'toggleLayerPanelCollapse',
            events: ['click'],
            affects: ['panel-right-layer-body'],
            examples: ['data-action="js:toggleLayerPanelCollapse"']
        },
        ...
        'panel-right-layer-mainname-badge': {
            ...
            io: { input: [], output: [] },
            logic: 'vm.layerMainName 값이 존재할 때만 표시.',
            py_func: null,
            js_action: null,
            events: [],
            affects: [],
        ...
        'panel-right-layer-matrix-container': {
            module: 'panel.right.layer',
            desc: '레이어 매트릭스 스크롤 컨테이너',
            io: { input: [], output: [] },
            logic: '컬럼 헤더 및 각 행(EFF/TXT/BG)을 가로 스크롤 가능하게 표시.',
            py_func: null,
            js_action: null,
            events: [],
            affects: ['panel-right-layer-col-{id}', 'panel-right-layer-row-{id}', 'panel-right-layer-cell-{id}'],
            examples: []
        },
        'panel-right-layer-col-{id}': {
            module: 'panel.right.layer',
            desc: '개별 레이어 컬럼 헤더 셀',
            io: { input: ['contextmenu', 'input'], output: ['컬럼 이름/색상 변경'] },
            logic: '우클릭으로 색상 선택 메뉴를 열고, input으로 컬럼 이름을 수정.',
            py_func: null,
            js_action: null,
            events: ['contextmenu'],
            affects: ['panel-right-layer-col-name-{id}', 'panel-right-layer-color-menu'],
            examples: []
        },
        'panel-right-layer-col-name-{id}': {
            module: 'panel.right.layer',
            desc: '레이어 컬럼 이름 입력 필드',
            io: { input: ['input'], output: ['vm.layerCols[].name 변경'] },
            logic: '컬럼의 표시 이름을 변경.',
            py_func: null,
            js_action: null,
            events: ['input'],
        ...
        'panel-right-layer-cell-{id}': {
            module: 'panel.right.layer',
            desc: '레이어 매트릭스의 개별 셀',
            io: { input: ['click'], output: ['vm.addLayerBox 호출'] },
            logic: '클릭 시 해당 컬럼/타입에 대응하는 캔버스 박스를 추가.',
            py_func: null,
            js_action: 'layerAddBox',
            events: ['click'],
            affects: ['preview-canvas-scaler'],
            examples: ['data-action="js:layerAddBox"']
        },
        'panel-right-layer-save-template-btn': {
            module: 'panel.right.layer',
            desc: '레이어 템플릿 저장 버튼',
            io: { input: ['click'], output: ['Swal.prompt → vm.saveLayerTemplate 호출'] },
            ...
            examples: ['data-action="js:layerSaveTemplate"']
        },
        'panel-right-layer-color-menu': {
            module: 'panel.right.layer',
            desc: '레이어 컬럼 색상 선택 컨텍스트 메뉴',
            io: { input: ['click(색상 스와치)'], output: ['해당 컬럼 color 변경'] },
        ...
        'panel-right-layer-color-swatch-{id}': {
            ...
            io: { input: ['click'], output: ['선택한 컬럼의 색상 변경'] },
        ...
        'panel-right-props-root': {
            ...
            desc: '우측 패널 - 속성(Properties) 영역 루트',
            io: { input: [], output: [] },
            logic: '선택된 박스/클립의 속성을 표시하고 편집하는 영역.',
            py_func: null,
            js_action: null,
            events: [],
            affects: [],
         ...
         * --------------------------------------------------- */
        'project-modal': {
            module: 'modal.project',
            desc: '프로젝트 생성/편집 모달',
            io: { input: [], output: [] },
            logic: '새 프로젝트 생성 또는 기존 프로젝트 설정을 편집하는 모달.',
            py_func: null,
            js_action: null,
            events: [],
            affects: [],
        ...
        'layer-template-modal-overlay': {
            module: 'modal.layerTemplate',
            desc: '레이어 템플릿 관리 모달 오버레이',
            io: { input: [], output: [] },
            logic: '레이어 템플릿을 저장/불러오기/삭제하는 모달.',
            py_func: null,
            js_action: null,
            events: [],
            affects: [],
        ...
        'asset-manager-modal': {
            module: 'modal.assetManager',
            desc: '자산 관리 모달',
            io: { input: [], output: [] },
            logic: '프로젝트 자산을 관리하는 모달.',
            py_func: null,
            js_action: null,
            events: [],
            affects: [],
        ...
        'image-asset-modal': {
            module: 'modal.imageAsset',
            desc: '이미지 자산 모달',
            io: { input: [], output: [] },
            logic: '이미지 자산을 추가/편집하는 모달.',
            py_func: null,
            js_action: null,
            events: [],
            affects: [],
        ...
        'image-effect-modal': {
            module: 'modal.imageEffect',
            desc: '이미지 이펙트 모달',
            io: { input: [], output: [] },
            logic: '이미지에 이펙트를 적용하는 모달.',
            py_func: null,
            js_action: null,
            events: [],
            affects: [],
        ...
        'visualization-modal': {
            module: 'modal.visualization',
            desc: '시각화 모달',
            io: { input: [], output: [] },
            logic: '데이터 시각화 옵션을 설정하는 모달.',
            py_func: null,
            js_action: null,
            events: [],
            affects: [],
        ...
        'api-manager-modal': {
            module: 'modal.apiManager',
            desc: 'API 관리 모달',
            io: { input: [], output: [] },
            logic: 'API 키 및 엔드포인트를 관리하는 모달.',
            py_func: null,
            js_action: null,
            events: [],
            affects: [],
        ...
        'dev-overlay-root': {
            module: 'dev.overlay',
            desc: 'Dev/Inspector 모드 오버레이 루트',
            io: { input: [], output: [] },
            logic: 'Dev 모드 또는 Inspector 모드 활성화 시 표시되는 오버레이.',
            py_func: null,
            js_action: null,
            events: [],
            affects: [],
    ...
    function getSpec(id) {
        ...
        // 동적 ID 패턴 매칭 (예: preview-canvas-box-123 → preview-canvas-box-{id})
    ...
    // 전역 노출
    global.WAI_getElementSpec = getSpec;
    global.WAI_getAllElementSpecs = getAllSpecs;
