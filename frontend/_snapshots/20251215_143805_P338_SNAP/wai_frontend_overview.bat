...
REM       - 현재 시점의 폴더/파일 트리 구조
REM       - 파일별 경로 + 간략한 역할 설명 (확장자 기반)
REM 이 화면을 그대로 복사해서 새 ChatGPT 채팅 첫 메시지로 사용
REM ============================================================
...
REM ----- Markdown 출력 시작 -----
echo # WAI-UI frontend 폴더/파일 구조 및 개요
echo
echo 생성 시점: !DATESTR!
...
echo ---
echo
echo ## 1. frontend 폴더/파일 트리 구조
echo
echo 아래는 현재 시점의 frontend 전체 트리 구조이다. (tree /F /A)
...
echo ^> 현재 frontend 폴더/파일 구조와 각 파일의 대략적인 역할을 공유할 수 있습니다.
echo.
