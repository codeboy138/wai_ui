...
export default {
    ...
    template: \`
        <main class="c-layout">
            <aside class="c-layout__panel c-layout__panel--left" 
                   :style="{ width: vm.leftPanelWidth + 'px', minWidth: '180px' }">
                <div class="c-layout__panel-header">
                    <span>자산 (Assets)</span>
                    <button class="c-layout__panel-btn" 
                            title="자산 추가"
                            @click="$parent.firePython('import_asset')">+</button>
                </div>
                ...
                <div id="layout-resizer-left"
                     class="c-layout__resizer c-layout__resizer--vertical c-layout__resizer--right"
                     title="패널 크기 조절"></div>
            </aside>
            ...
            <section class="c-layout__center">
                <div id="preview-container-main" 
                     ...
                     :style="{ height: vm.previewContainerHeight }">
                    
                    <preview-toolbar :vm="vm"></preview-toolbar>
                    
                    <div id="canvas-wrapper-main"
                         class="c-layout__preview-canvas" 
                         @mousemove="updateCanvasMouseCoord" 
                         @mouseleave="vm.mouseCoord = {x: 0, y: 0}; vm.isMouseOverCanvas = false">
                        
                        <div class="c-layout__ruler c-layout__ruler--horizontal">
                            <ruler-line orientation="h" 
                                      :max-size="vm.canvasSize.w" 
                                      :scale="vm.canvasScale"></ruler-line>
                        </div>
                        <div class="c-layout__ruler c-layout__ruler--vertical">
                            <ruler-line orientation="v" 
                                      :max-size="vm.canvasSize.h" 
                                      :scale="vm.canvasScale"></ruler-line>
                        </div>
                        ...
                        <div class="c-layout__crosshair" 
                            ...
                            <div class="c-layout__crosshair-line c-layout__crosshair-line--vertical" 
                                 :style="{left: vm.mouseMarkerPos.x + 'px'}" 
                                 v-show="vm.isMouseOverCanvas"></div>
                            <div class="c-layout__crosshair-line c-layout__crosshair-line--horizontal" 
                                 :style="{top: vm.mouseMarkerPos.y + 'px'}" 
                                 v-show="vm.isMouseOverCanvas"></div>
                        </div>
                        ...
                        <div class="c-layout__canvas-viewport">
                            <div id="canvas-scaler-transform" 
                                ...
                                <preview-canvas :canvas-boxes="vm.canvasBoxes" 
                                              :selected-box-id="vm.selectedBoxId" 
                                              @select-box="vm.setSelectedBoxId" 
                                              @remove-box="vm.removeBox"></preview-canvas>
                            </div>
                        </div>
                    </div>
                </div>
                
                <div id="layout-resizer-timeline"
                     class="c-layout__resizer c-layout__resizer--horizontal"
                     title="타임라인 크기 조절"></div>
                
                <timeline-panel :vm="vm" 
                              :style="{ height: vm.timelineContainerHeight }"></timeline-panel>
            </section>
            
            <aside class="c-layout__panel c-layout__panel--right" 
                   :style="{ width: vm.rightPanelWidth + 'px', minWidth: '250px' }">
                <div id="layout-resizer-right"
                     class="c-layout__resizer c-layout__resizer--vertical c-layout__resizer--left"
                     title="패널 크기 조절"></div>
                <div class="c-layout__panel-content">
                    <layer-panel :vm="vm"></layer-panel>
                    <properties-panel :vm="vm"></properties-panel>
