...
// 코드연결지점
    ...
    methods: {
        ...
        // 수정된 selectClip - Ctrl+클릭으로 선택된 클립 토글
...
// 코드연결지점
        ...
        // 수정된 finalizeDrop - 공간 없으면 원래 자리로 복귀
        ...
        // 수정된 openClipContextMenu - 다중 선택 유지
        openClipContextMenu: function(e, track, clip) { 
            ...
            if (clip) {
                ...
                // 이미 선택된 클립을 우클릭하면 기존 선택 유지 (아무것도 하지 않음)
            }
