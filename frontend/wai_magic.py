...
# [설정]
# ==========================================
TARGET_ROOT = r"C:\wai-ui\frontend"  # 파일 저장 위치 (frontend 폴더)
GIT_ROOT = r"C:\wai-ui"              # Git 저장소 루트
LAST_CONTENT = ""
GIT_ENABLED = False
...
def git_commit_and_push(filename):
    ...
    try:
        ...
        # Git add (frontend 폴더 기준 상대 경로)
        git_file_path = f"frontend/{filename}"
        subprocess.run(['git', 'add', git_file_path], capture_output=True, text=True, check=True)
        
        # Git commit
        commit_msg = f"[WAI:Magic] {filename}"
        ...
        if result_commit.returncode == 0:
            ...
            if AUTO_PUSH_ENABLED:
                ...
                if result_push.returncode == 0:
                    print(f"   🚀 [Push] https://github.com/codeboy138/wai_ui")
                else:
...
# ==========================================
print(f"=============================================")
print(f"   🎩 WAI Magic Sync v3.0 (Hybrid Edition)")
...
if GIT_ENABLED:
    if AUTO_PUSH_ENABLED:
        ...
        print(f"   🔥 커밋만 활성 (원격 미연결)")
else:
    print(f"   ⚠️ Git 비활성 (저장만 수행)")

print(f"\n   📡 [대기 중] 클립보드 감시...")
print(f"   ✅ 지원 파일:")
print(f"      - index.html")
print(f"      - css/app.css")
print(f"      - js/app-core.js")
print(f"      - js/app-components.js")
print(f"      - js/app-timeline.js")
print(f"      - js/app-canvas.js")
print(f"      - js/app-panels.js")
print(f"      - js/app-utils.js")
print(f"=============================================\n")
